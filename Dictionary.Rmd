---
title: "Dictionary of AnonymityPoll.csv"
author: 'Saeid Abolfazli '
date: "April 27, 2016"
output: pdf_document
---
## Description
Below we provide features stored in AnonymityPoll.csv dataset. THe complete dataset related to the 2013 July pool can be found from [here](http://www.pewinternet.org/datasets/july-2013-anonymity-omnibus/)

###Credit:
Goes to lecturers and admins in EDX MITx: 15.071x The Analytics Edge course.
